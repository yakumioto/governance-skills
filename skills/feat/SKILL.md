...
- **允许读取：**
  ...
  - `{project_root}/templates/feature.md`           # 优先：用户工作项目的 templates
  - `{global_root}/templates/feature.md`           # 备用：全局模板目录 $HOME/.claude/skills/templates/
  - `{plugin_root}/templates/feature.md`            # 备用：插件自带 templates
  - `{project_root}/templates/tasks.md`             # 优先：用户工作项目的 templates
  - `{global_root}/templates/tasks.md`             # 备用：全局模板目录 $HOME/.claude/skills/templates/
  - `{plugin_root}/templates/tasks.md`              # 备用：插件自带 templates
- **允许写入/修改：**
